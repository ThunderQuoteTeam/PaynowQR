                          ...
                          <div v-if="customLogo === 'text'">
                            ...
                            <div>
                              <b-form-group
                                ...
                                class="mt-2"
                              >
                                <b-form-input id="logo-text-font-size" size="sm" type="range" step="1" min="0" max="200" v-model="qrLogoText.fontSize"></b-form-input>
                              </b-form-group>
                            </div>
                            ...
                            <div>
                              <b-form-group
                                ...
                                class="mt-2"
                              >
                                <b-form-input ref="logoTextColor" id="text-logo-color" size="sm" type="color" v-model="qrLogoText.textColor"></b-form-input>
                              </b-form-group>
                            </div>
                            ...
                            <div>
                              <b-form-group
                                ...
                                class="mt-2"
                              >
                                <b-form-input id="logo-text-x" size="sm" type="range" step="1" min="25" max="500" v-model="qrLogoText.x"></b-form-input>
                              </b-form-group>
                            </div>
                            ...
                            <div>
                              <b-form-group
                                ...
                                class="mt-2"
                              >
                                <b-form-input id="logo-text-y" size="sm" type="range" step="1" min="-23" max="500" v-model="qrLogoText.y"></b-form-input>
                              </b-form-group>
                            </div>
                            ...
                            <div>
                              <b-form-group
                                ...
                                class="mt-2"
                              >
                                <b-form-input id="logo-text-width" size="sm" type="range" step="1" min="0" max="450" v-model="qrLogoText.width"></b-form-input>
                              </b-form-group>
                            </div>
                            ...
                            <div>
                              <b-form-group
                                ...
                                class="mt-2"
                              >
                                <b-form-input id="logo-text-height" size="sm" type="range" step="1" min="0" max="500" v-model="qrLogoText.height"></b-form-input>
                              </b-form-group>
                            </div>
                            ...
                            <div>
                              <b-form-group
                                ...
                                class="mt-2"
                              >
                                <b-form-input id="logo-text-line-height" size="sm" type="range" step="1" min="90" max="300" v-model="qrLogoText.lineHeight"></b-form-input>
                              </b-form-group>
                            </div>
                          </div>  
                        ...
                        <div v-if="qrLogo.src">
                          ...
                          <div>
                              <b-form-group
                                ...
                                class="mt-2"
                              >
                                <b-form-input id="logo-width" size="sm" type="range" step="1" min="1" max="121" v-model="qrLogo.logoHeightWidth"></b-form-input>
                              </b-form-group>
                            </div>
                          ...
                          <div v-if="qrLogo.src">
                            ...
                            <div>
                              <b-form-group
                                ...
                                class="mt-2"
                              >
                                <b-form-input id="logo-size" size="sm" type="range" step="1" min="1" max="121" v-model="qrLogo.logoHeightWidth"></b-form-input>
                              </b-form-group>
                            </div>
